...
int t1() {
  ...
  */
  ...
  ASSERT(lnr_match_g(t, (gtype[]){gtype_l(1), gtype_l(2), gtype_l(3)}, 3), "lnr match 1 2 3");
  bn_free_tree(t);
  ...
  */
  ...
  ASSERT(lnr_match_g(t, (gtype[]){gtype_l(1), gtype_l(2), gtype_l(3), gtype_l(5)
                                  , gtype_l(6), gtype_l(8), gtype_l(9)}, 7),
